...
def help_text() -> str:
    return (
        ...
        "/digest_on [time] — enable digest, optional time (e.g. /digest_on 8pm, /digest_on 20:00)\n"
        "/digest_off — disable daily auto-digest\n"
        "/digest_time &lt;time&gt; — change digest time without toggling (e.g. /digest_time 9:15pm)\n"
